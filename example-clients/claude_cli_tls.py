#!/usr/bin/env python
# example-clients/claude_cli_tls.py - TLS-enabled version
import asyncio
import dotenv
import os
import sys
...
pg_mcp_url = os.getenv('PG_MCP_URL', 'https://localhost:8443/sse')  # Use HTTPS
...
async def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python claude_cli_tls.py 'your natural language query'")
        sys.exit(1)
